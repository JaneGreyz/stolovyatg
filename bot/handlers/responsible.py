...
from bot.filters.responsible import ManagerAccessFilter, ResponsibleStaffFilter
...
def create_responsible_router(settings: Settings) -> Router:
    ...
    responsible_filter = ResponsibleStaffFilter(settings)
    ...
    @router.message(CommandStart(), responsible_filter)
